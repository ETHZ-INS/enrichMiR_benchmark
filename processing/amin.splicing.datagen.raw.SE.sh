...
fc_opts="-O --largestOverlap --nonOverlap 3 --fracOverlap 0.9 --primary -s 0 -T 2 --extraAttributes gene_name,gene_biotype"
featureCounts -t exon $fc_opts -a $a -o spliced.counts /mnt/schratt/p1006/Amin_2015/STAR_2/*.sam
featureCounts -t exon --nonSplitOnly $fc_opts -a $a -o exonicNonSplit.counts /mnt/schratt/p1006/Amin_2015/STAR_2/*.sam
featureCounts -t transcript --nonSplitOnly $fc_opts -a $a -o unspliced.tmp.counts /mnt/schratt/p1006/Amin_2015/STAR_2/*.sam
...
saveRDS(sp, file="amin.splicing.raw.SE.rds")
