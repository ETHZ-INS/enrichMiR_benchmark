...
featureCounts -t exon $fc_opts -a $a -o spliced.counts /mnt/schratt/p3153_ratPolyA_mirDuplexes/STAR_40416_2019-10-24--09-03-17/*.bam
featureCounts -t exon --nonSplitOnly $fc_opts -a $a -o exonicNonSplit.counts /mnt/schratt/p3153_ratPolyA_mirDuplexes/STAR_40416_2019-10-24--09-03-17/*.bam
featureCounts -t transcript --nonSplitOnly $fc_opts -a $a -o unspliced.tmp.counts /mnt/schratt/p3153_ratPolyA_mirDuplexes/STAR_40416_2019-10-24--09-03-17/*.bam
...
saveRDS(sp, file="ratPolyA.splicing.raw.SE.rds")
