...
featureCounts -t exon $fc_opts -a $a -o spliced.counts /mnt/schratt/p1006/Whipple_2020_SmallRNA/STAR/*.sam
featureCounts -t exon --nonSplitOnly $fc_opts -a $a -o exonicNonSplit.counts /mnt/schratt/p1006/Whipple_2020_SmallRNA/STAR/*.sam
featureCounts -t transcript --nonSplitOnly $fc_opts -a $a -o unspliced.tmp.counts /mnt/schratt/p1006/Whipple_2020_SmallRNA/STAR/*.sam
...
saveRDS(sp, file="whipple.splicing.raw.SE.rds")
