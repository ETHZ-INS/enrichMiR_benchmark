...
title: |  
  ...
  | \vspace{0.2cm} \huge{miRNA target enrichment benchmark and application to neuronal differentiation identifies miRNAs putatively involved in maturation}  
  | \vspace{2.5cm} \normalsize{Departement of Systems Biology / D-BIOL, ETH Zürich}  
...
subtitle: |  
  ...
  | \vspace{0.1cm} \normalsize{Prof. Dr. Ciaudo, C., Inst. f. Molecular Health Sciences, ETH Zürich, Referee}   
...
\LARGE  
miRNA target enrichment benchmark and application to neuronal differentiation identifies miRNAs putatively involved in maturation
\vspace{0.3cm}  
\small  
Tomás Germade  
...
We selected five datasets, derived from different organisms and tissues, and including a total of 33 miRNA perturbations, have been selected to serve as benchmark datasets based on their single-miRNA perturbation structure. For the purpose of simplification, we refer to the different datasets as *Bartel*, *Rat*, *Jeong*, *Amin* and *Cherone* based on the authors of their respective publications. A more detailed summary of each dataset can be found in Table 1 and the [Materials & Methods](#benchmark-datasets) section.  
