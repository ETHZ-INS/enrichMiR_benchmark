...
```{r pca esc unsep, message=FALSE, warning=FALSE, eval=TRUE}
...
```{r pca esc spliced, message=FALSE, warning=FALSE, eval=TRUE}
...
```{r pca esc unspliced, message=FALSE, warning=FALSE, eval=TRUE}
...
```{r pca in unsep, message=FALSE, warning=FALSE, eval=TRUE}
...
```{r pca in spliced, message=FALSE, warning=FALSE, eval=TRUE}
...
```{r pca in unspliced, message=FALSE, warning=FALSE, eval=TRUE}
...
```{r exon dea batchA, message=FALSE, warning=FALSE, results='hide', eval=TRUE}
...
```{r heatmap comb esc, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, eval=TRUE}
...
```{r heatmap comb in, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, eval=TRUE}
...
```{r heatmap batch esc, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, eval=TRUE}
...
```{r heatmap batch in, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, eval=TRUE}
...
```{r heatmap batchA esc, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, eval=TRUE}
...
```{r heatmap batchA in, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, eval=TRUE}
...
```{r MA plot esc, warning=FALSE, message=FALSE, eval=TRUE}

# logCPM vs logFC scatterplot ESC
LSD:::heatscatter(as.vector(assays(se.esc.batchA)$logcpm),as.vector(assays(se.esc.batchA)$log2FC))
abline(a=0, b=0)
```

#### iN

```{r MA plot in, warning=FALSE, message=FALSE, eval=TRUE}

# logCPM vs logFC scatterplot iN
LSD:::heatscatter(as.vector(assays(se.in.batchA)$logcpm),as.vector(assays(se.in.batchA)$log2FC))
abline(a=0, b=0)
```
...
```{r spliced ratios esc, warning=FALSE, message=FALSE, eval=TRUE}
...
```{r spliced ratios in, warning=FALSE, message=FALSE, eval=TRUE}
...
```{r significance signs batchA, warning=FALSE, message=FALSE, eval=TRUE}
...
```{r signs plot comb esc, message=FALSE, warning=FALSE, fig.width=12, eval=TRUE}
...
```{r signs plot comb in, message=FALSE, warning=FALSE, fig.width=12, eval=TRUE}
...
```{r signs plot batch esc, message=FALSE, warning=FALSE, fig.width=12, eval=TRUE}
...
```{r signs plot batch in, message=FALSE, warning=FALSE, fig.width=12, eval=TRUE}
...
```{r signs plot batchA esc, message=FALSE, warning=FALSE, fig.width=12, eval=TRUE}
...
```{r signs plot batchA in, message=FALSE, warning=FALSE, fig.width=12, eval=TRUE}
...
se.esc.batchA <- roundSE(se.esc.batchA)
se.in.batchA <- roundSE(se.in.batchA)
# export
saveRDS(se.esc.batchA, "data/whipple.esc.exon.DEA.SE.rds")
saveRDS(se.in.batchA, "data/whipple.in.exon.DEA.SE.rds")
```
