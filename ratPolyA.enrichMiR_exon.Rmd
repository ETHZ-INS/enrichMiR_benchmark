...
# ratPolyA DEA with exon resolution
# miRNA effect
se.test <- exonDEA(se, model = ~readtype+miRNA, model0 = ~readtype, control="Neg")
## number of significant tx
...
se.test2 <- exonDEA(se, model = ~readtype*miRNA, model0 = ~readtype, control="Neg")
## number of significant tx
...
```{r exon dea batch 4, message=FALSE, warning=FALSE, eval=TRUE}
...
# batch4 [model = ~rep+readtype*miRNA, model0 = ~rep+readtype+miRNA]
