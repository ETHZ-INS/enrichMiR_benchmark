...
# export
saveRDS(dea.list.hela, "~/master_19_20/iPSCdiff/enrichMiR/bartel_HeLa.deaList.rds")
```

```{r import hela bartel}

# import
dea.list.hela <- readRDS("~/master_19_20/iPSCdiff/enrichMiR/bartel_HeLa.deaList.rds")
```
...
# export
saveRDS(dea.list.hek, "~/master_19_20/iPSCdiff/enrichMiR/bartel_HEK.deaList.rds")
```

```{r import hek bartel}

# import
dea.list.hek <- readRDS("~/master_19_20/iPSCdiff/enrichMiR/bartel_HEK.deaList.rds")
```
...
# export
saveRDS(dea.list.hek_nb, "~/master_19_20/iPSCdiff/enrichMiR/bartel_HEK_noBatch.deaList.rds")
```

```{r import hek no batch bartel}

# import
dea.list.hek_nb <- readRDS("~/master_19_20/iPSCdiff/enrichMiR/bartel_HEK_noBatch.deaList.rds")
```
