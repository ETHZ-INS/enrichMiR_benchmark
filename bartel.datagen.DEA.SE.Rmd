...
```{r allocation, warning=FALSE, message=FALSE, eval=TRUE}
...
```{r load se, warning=FALSE, message=FALSE, eval=TRUE}

# load raw SE file
se <- readRDS(input)
```

```{r separate celltypes bartel, warning=FALSE, message=FALSE, eval=TRUE}
...
```{r pca bartel, warning=FALSE, message=FALSE, eval=TRUE}
...
```{r dea bartel function, message=FALSE, warning=FALSE, eval=TRUE}
...
```{r dea bartel, message=FALSE, warning=FALSE, eval=TRUE}
...
```{r sig tx changes bartel, message=FALSE, warning=FALSE, eval=TRUE}
...
```{r hek comparison bartel, message=FALSE, warning=FALSE, eval=TRUE}
...
## Remove skewing genes (see: bartel.exon_datagen.DEA.SE.Rmd)

```{r exclude skewing genes, warning=FALSE, message=FALSE, eval=TRUE}
...
se.hek <- se.hek[!(rownames(se.hek) %in% skewed.hek),]
```

## Export

```{r export hela batch bartel, warning=FALSE, message=FALSE, eval=TRUE}
...
```{r import hela batch bartel, warning=FALSE, message=FALSE, eval=TRUE}

# import HeLa
se.hela <- readRDS(output1)
```

```{r export hek batch bartel, warning=FALSE, message=FALSE, eval=TRUE}
...
```{r import hek batch bartel, warning=FALSE, message=FALSE, eval=TRUE}

# import HEK
se.hek <- readRDS(output2)
```


## Heatmaps

```{r hm bartel, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, eval=TRUE}
